   ...
   // GPSTracker gps;
    ...
    protected void initMapSettings() {
        ...
        if (userLastLocation.canGetLocation()) {
            ...
            setUpMarker(lattitude, langitude, userLastLocation.getLatitude(), userLastLocation.getLongitude());

            sendRequestToServer(AppConstant.DirectionApiUrl(userLastLocation.getLatitude(), userLastLocation.getLongitude(), lattitude, langitude));
        } else {
